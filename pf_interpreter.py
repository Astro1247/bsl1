from lexer import lex, tableToPrint,  tableOfId, tableOfConst, tableOfLabel, sourceCode, FSuccess
from pfcode_translator import postfixTranslator, postfixCode, FSuccess
