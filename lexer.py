...
tableOfLanguageTokens = \
    {'bsl1': 'keyword', 'end':'keyword', \
     'if': 'keyword', 'do': 'keyword', 'else': 'keyword', 'while': 'keyword', 'then': 'keyword', \
     'input': 'keyword', 'print': 'keyword', \
     ':=': 'assign_op', '.': 'dot', ' ': 'ws', '\t': 'ws', '\n': 'nl', '-': 'add_op', \
     '+': 'add_op', '*': 'mult_op', '/': 'mult_op', '(': 'brackets_op', ')': 'brackets_op', '{': 'brackets_op', '}': 'brackets_op',\
...
# Діаграма станів
#               Q                                   q0          F
# M = ({0,1,2,4,5,6,9,11,12,13,14,101,102,103,105}, Σ,  δ , 0 , {2,6,9,12,13,14,101,102,103,105})
